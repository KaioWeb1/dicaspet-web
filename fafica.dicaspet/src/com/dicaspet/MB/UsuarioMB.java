...
public class UsuarioMB implements Serializable{
	...
	public Set<Servico>getMeusServicos(){
		usuario = (Usuario) FacesContextUtil.getSessionAttribute("usuario");
		System.out.println("Buscou meus serviços");
	...
	public String cadastrar() {
		...
		// cadastrar o usuï¿½rio
		// recuperar o usuario da base (com o id)
		// atualizar o objeto do usuï¿½rio no objeto animal
		// cadasrar animal
		...
		if( fachada.controladorUsuario().existeLogin(usuario.getUsu_email()) ){
			...
			FacesMessage message2 = new FacesMessage(FacesMessage.SEVERITY_WARN, "E-mail jÃ¡ cadastrado","E-mail jï¿½ cadastrado");
	...
	public void autenticar(){
		...
		if(user==null){
			...
			user.setAtivo(true);
			/*
			FacesMessage messageWarn = new FacesMessage(FacesMessage.SEVERITY_WARN,"Login e/ou Senha inválido",
...
//			}else{
			...
			FacesMessage message = FacesMessageUtil.criarMensagemInfo(
					"Adotado com Sucesso!", "vocï¿½ adotou um "+adotado.getAni_especie() +" parabens!");
